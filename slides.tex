...
\begin{frame} {Architeture overview}
\centerline {
...
\begin {itemize}
  ...
  \item implements abstraction {\color{red}\texttt{TaskAbstract}}
    \vskip .5cm
    \centerline {
      \includegraphics [width=.6\linewidth] {figures/task.pdf}
    }
...
\begin{frame} {Solver \texttt{SOT}}
  ...
  \vskip .5cm
  \centerline {
    \includegraphics [width=.6\linewidth]{figures/sot.pdf}
  }
  \begin{itemize}
...
\begin{frame} {Installation}
  ...
  \begin{itemize}
  \item \texttt {\tiny
    git clone git://github.com/jrl-umi3218/jrl-mal.git\\
    git clone git://github.com/jrl-umi3218/jrl-mathtools.git\\
    git clone git://github.com/laas/abstract-robot-dynamics.git\\
    git clone git://github.com/jrl-umi3218/jrl-dynamics.git\\
    git clone git://github.com/jrl-umi3218/dynamic-graph.git\\
    git clone git://github.com/jrl-umi3218/dynamic-graph-python.git\\
    git clone git://github.com/jrl-umi3218/sot-core.git\\
    git clone git://github.com/laas/sot-tools.git\\
    git clone git://github.com/jrl-umi3218/sot-dynamic.git
  }
    \pause
